...
function AvatarGroupCount({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex size-6 shrink-0 items-center justify-center rounded-full bg-secondary text-[10px] font-medium text-muted-foreground ring-2 ring-background",
        className
      )}
      {...props}
    />
